...
REFLECT(gem::ComponentBase)
	MEMBERS {
		REF_MEMBER(typeId,    readonly())
		REF_MEMBER(isEnabled, readonly())
	}
REF_END;
...
REFLECT(gem::Entity)
	...
	MEMBERS {
		REF_MEMBER(components, readonly())
		REF_MEMBER(tags,       readonly())
		REF_MEMBER(isEnabled,  readonly(), display_name("Enabled"))
	}
REF_END;
